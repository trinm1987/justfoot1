...
{
    // coinvest, 통신 포트
    return GetBoolArg("-testnet", false) ? 49901 : 59901;
}
...
Value stop(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "Stop SafeCoin server (and possibly override the detachdb config value).");
...
void ThreadRPCServer2(void* parg)
{
        ...
        (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"]))
    {
        ...
        string strWhatAmI = "To use SafeCoind";
